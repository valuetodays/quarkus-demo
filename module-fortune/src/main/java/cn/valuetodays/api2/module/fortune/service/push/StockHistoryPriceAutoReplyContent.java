 ...
 */
@ApplicationScoped
public class StockHistoryPriceAutoReplyContent implements AutoReplyContent {
    @Inject
    ...
    public Pair<PushBaseReq.ContentType, String> replyContent(String value) {
        String v = stockHistoryPriceService.computeOffsetDistribution(value);
